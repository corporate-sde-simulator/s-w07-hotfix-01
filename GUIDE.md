...
> **Welcome to Service-Track Week 7, Hotfix 1!**
...
1. **Read the comments** at the top of `invoiceGenerator.py` - they describe the problem
...
| File | Purpose |
|------|---------|
| `invoiceGenerator.py` | The code with bugs - **fix this file** |
...
### Bug #1
**User Report / Alert:**
> "Rounds tax per line item â€” accumulates rounding errors"
...
### Bug #2
**User Report / Alert:**
> "No thousands separator, no decimal formatting"
...
### Bug #3
**User Report / Alert:**
> "No column alignment â€” description width varies"
...
1. **Read the top comment block** in `invoiceGenerator.py` carefully - it has:
